...
global wage ggamma intermediateGoodsPriceSS
intermediateGoodsPriceSS = (ggamma - 1) / ggamma;
...
% Populate workspace with full results (hits persistent cache if wage unchanged)
[~,vMoments,vParameters,aggregateConsumption,marginalUtility,aggregateOutput,aggregateCapital,aggregateInvestment] = ...
	computeLMCResidualPolynomials(wage,vParameters,vMomentsHistogram,mGridMoments);

% Compute final VFI coefficients at the converged wage for dynamicModel_steadystate.m
