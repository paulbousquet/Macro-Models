...
parameters ttheta nnu ddelta rrhoProd ssigmaProd aaUpper aaLower ppsiCapital
	bbeta ssigma pphi nSS rrhoTFP ssigmaTFP ggamma vvarphi rrho_r vvarphi_pi
	kkappa rrhoMonetary ssigmaMonetary intermediateGoodsPriceSS nominalInterestRateSS
	cchi rrhoBeta ssigmaBeta;

// Load in their values
@#define nEconomicParameters = 26
