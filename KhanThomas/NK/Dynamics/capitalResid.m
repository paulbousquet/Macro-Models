...
global nCapital capitalMin capitalMax nShocks nState bbeta vShocksWeights ddelta nProd
...
mPolyPrime = repmat(mProdPrimePoly, 1, nCapital) .* repelem(mCapitalPrimePoly, 1, nProd);
