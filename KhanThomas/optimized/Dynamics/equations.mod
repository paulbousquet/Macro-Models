...
@#for iProd in 1 : nProd
	(marginalUtility / exp(aggregateQ)) = bbeta * exp(aggregateBeta) * (
	@#for iShock in 1 : nShocks
...
//----------------------------------------------------------------
// Law of motion for aggregate shocks (# equations = 3)
//----------------------------------------------------------------
...
realInterestRate = 100 * ((marginalUtility / (bbeta * exp(aggregateBeta) * expectedMarginalUtilityPrime)) - 1);
